        ...
        >
          <div className="w-full p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-xl text-center lg:text-left flex-1">
              ...
              <Link
                href="/scholarships"
                className="inline-flex items-center justify-center px-6 py-3 border border-brand-border text-xs font-semibold rounded-full text-brand-dark bg-white hover:bg-brand-cream cursor-pointer transition-colors"
              >
