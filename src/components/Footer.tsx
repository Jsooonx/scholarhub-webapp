        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="lg:col-span-2 flex flex-col justify-between max-w-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="#" className="text-brand-muted hover:text-brand-dark transition-colors flex items-center justify-center" aria-label="Threads">
              ...
              <a href="#" className="text-brand-muted hover:text-brand-dark transition-colors flex items-center justify-center" aria-label="Instagram">
